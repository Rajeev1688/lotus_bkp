...
(2, 'BANNER 2', '#', 'BANNER 2', 'N', '2_banner1.jpg', 0),
(3, 'BANNER 3', '#', 'BANNER 3', 'N', '3_banner2.png', 0),
(4, 'ABC', '#', 'hdh', 'N', '4_banner3.png', 0);
...
(1, 'Hello', '#', 'Y', '1_ADHU.jpg', 1),
(2, 'Hello', '#', 'Y', '2_logo23.png', 2),
(3, 'Hello', '#', 'Y', '3_logoo.png', 3),
(4, 'hello', '#', 'Y', '4_logo23.png', 4);
...
(1, '2014-08-22 02:31:08', 'Sunil Chouhan', '8655336008', 'CbONLINE PVT LTD', 'Developer', 'Thane', '9833118736', 'thane', 'Maharashtra', 'indIa', '', 'chouhan4it@gmail.com', 'Let See this contact us form', '127.0.0.1'),
(2, '2014-09-23 07:06:36', 'Sunil Chouhan', '8655336008', 'CbONLINE PVT LTD', 'Developer', 'Thane', '9833118736', 'Mahyarastra', '', 'indIa', 'I have designed following pages for 299BIS as follows', 'chouhan4it@gmail.com', 'Technocity IT Park,103, \r\nplot X4/1-2 MIDC, 1st Floor, A Wing, \r\nMahape, Navi Mumbai- 400710', '127.0.0.1'),
(3, '2015-09-20 08:33:43', 'Sunil', '8655336008', '', '', '', '', '', '', '', '', 'dipak123@gmail.com', 'Technocity IT Park,103, plot X4/1-2 MIDC, 1st Floor, A Wing, Mahape, Navi Mumbai- 400710', '127.0.0.1');
...
INSERT INTO `tbl_job` (`fldiJobId`, `fldvTitle`, `fldvLink`, `fldcStatus`, `fldvLogo`, `fldvPostion`) VALUES
(1, 'Job 1', '#', 'Y', '1_14456786922.png', 0),
(2, 'Job2', '#', 'Y', '2_14456786811.png', 0),
(3, 'Job3', '#', 'Y', '3_14456787013.png', 0),
(4, 'Job4', '#', 'Y', '4_14456787094.png', 1),
(5, 'Job5', '#', 'Y', '5_14456787185.png', 2),
(6, 'Job6', '#', 'Y', '6_14456787276.png', 3),
(7, 'Job7', '#', 'Y', '7_14456787377.png', 0),
(8, 'Job8', '#', 'Y', '8_14456787528.png', 0),
(9, 'Job9', '#', 'Y', '9_14456787699.png', 0),
(10, 'Job10', '#', 'Y', '10_144567878210.png', 0),
(11, 'Job11', '#', 'Y', '11_144567878911.png', 0);
...
('Pharma Learners', 'http://localhost/plearner/', 'N', 'lotusindiatech@gmail.com');
...
(12, 'Aman Farokh Sanjay double crown in nashik state championship', '', 'Developer', '12515_TestNews.jpg', 'Aman Farokh Sanjay double crown in nashik state <a target=\"\" title=\"\" href=\"http://egegert\">championship</a>', 'Y', '2015-03-04 00:00:00');
...
(1, 0, 0, 'Sunli', 'Chouhan', 'sunil', 'schouhan', '', '', '', '2015-11-09 23:26:05', 'SA', '01', 'Y', 'Y', 'Y', 'Y', 'Y'),
(2, 1, 1, 'Sauabh', 'Mahadev', 'pramodrbhadane@gmail.com', 'pramodrbhadane@gmail.com', 'pramodrbhadane@gmail.com', 'NA', '', '2015-11-06 01:28:23', 'SA', '01', 'Y', 'Y', 'Y', 'Y', 'Y');
...
(328, 7, 'Webcms', 'misc_webcms.php', 4),
(350, 7, 'FAQ', 'add_faq_quesans.php', 5),
(338, 7, 'News', 'misc_newsevents.php', 1),
(339, 7, 'Home Page Banner', 'misc_banner.php', 2),
...
(343, 17, 'Chapter', 'add_subcategory.php', 2),
(344, 7, 'Client', 'misc_client.php', 3),
(345, 17, 'Subject', 'add_category.php', 1),
...
(349, 17, 'Question', 'set_question.php', 3),
(351, 7, 'Videos', 'misc_videos.php', 6),
(352, 7, 'Job', 'misc_job.php', 7);
...
CREATE TABLE `tbl_post` (
  ...
  `fldvPostion` int(11) NOT NULL,
  `fldcPlacement` enum('TOP','LEFT') NOT NULL DEFAULT 'TOP',
  `flddDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `fldcStatus` enum('Y','N') NOT NULL DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(4, 0, 0, 'Thane City and District Badminton Association', '', 'THANE CITY AND DISTRICT BADMINTON ASSOCIATION CONTACT US', 'THANE CITY AND DISTRICT BADMINTON ASSOCIATION CONTACT US', '', '<p>Firefox can\"t find the server at s91.new3gpmovies.com.<br /><br />&nbsp;&nbsp;&nbsp; Check the address for typing errors such as ww.example.com instead of www.example.com<br />&nbsp;&nbsp;&nbsp; If you are unable to load any pages, check your computer\"s network connection.<br />&nbsp;&nbsp;&nbsp; If your computer or network is protected by a firewall or proxy, make sure that Firefox is permitted to access the Web.</p>', '', 0, 'LEFT', '2015-11-01 11:59:30', 'Y');
...
INSERT INTO `tbl_product_cat` (`fldiCatId`, `fldiPrntId`, `fldiInnerId`, `fldvCatName`, `fldvCatDesc`, `fldvCatImage`, `fldiPOrder`, `fldvLink`, `fldcStatus`, `fldcMenu`) VALUES
(1, 0, 0, 'Pharmaceutics', 'Pharmaceutics', '', 0, '', 'N', 'NA'),
(2, 0, 0, 'Pharmacutical Chemistry', 'Pharmacutical Chemistry', '', 0, '', 'N', 'NA'),
(3, 1, 0, 'Physical pharmacy', 'Physical pharmacy', '', 0, '', 'Y', 'NA'),
(4, 1, 0, 'Jurisprudence', 'Jurisprudence', '', 0, '', 'Y', 'NA'),
(5, 1, 0, 'Dosage form desigiing & Evaluation', 'Dosage form desigiing & Evaluation', '', 0, '', 'Y', 'NA'),
(10, 0, 0, 'Pharmacology', 'Pharmacology', '', 0, '', 'N', 'NA'),
(11, 0, 0, 'Microbiology & Biotechnology', 'Microbiology & Biotechnology', '', 0, '', 'N', 'NA'),
(8, 0, 3, 'Test1', 'Test1', '', 0, '', 'N', 'NA'),
(9, 0, 3, 'Test Topic 2', 'Test Topic 2', '', 0, '', 'N', 'NA'),
(12, 1, 0, 'Pharmaceutical Engineering', 'Pharmaceutical Engineering', '', 0, '', 'N', 'NA'),
(13, 1, 0, 'Biopharmaceutics and Pharmacokinetics', 'Biopharmaceutics and Pharmacokinetics', '', 0, '', 'N', 'NA'),
(14, 2, 0, 'Medicinal Chemistry', 'Medicinal Chemistry', '', 0, '', 'N', 'NA'),
(15, 2, 0, 'Organic Chemistry', 'Organic Chemistry', '', 0, '', 'N', 'NA'),
(16, 2, 0, 'Pharmaceutical Analysis', 'Pharmaceutical Analysis', '', 0, '', 'N', 'NA'),
(17, 2, 0, 'Bio chemistry', 'Bio chemistry', '', 0, '', 'N', 'NA'),
(18, 10, 0, 'Hemopoietic System', 'Hemopoietic System', '', 0, '', 'N', 'NA'),
(19, 10, 0, 'Pathophysiology', 'Pathophysiology', '', 0, '', 'N', 'NA'),
(20, 1, 0, 'System p&#65533;cology & Drug action', 'System p&#65533;cology & Drug action', '', 0, '', 'N', 'NA'),
(21, 1, 0, 'Pharmacpgnostic study', 'Pharmacpgnostic study', '', 0, '', 'N', 'NA'),
(22, 10, 0, 'Phytochemical Screening', 'Phytochemical Screening', '', 0, '', 'N', 'NA'),
(23, 10, 0, 'Biosynthetic studies', 'Biosynthetic studies', '', 0, '', 'N', 'NA'),
(24, 1, 0, 'Microbiology', 'Microbiology', '', 0, '', 'N', 'NA'),
(25, 11, 0, 'Biotechnology', 'Biotechnology', '', 0, '', 'N', 'NA');
...
CREATE TABLE `tbl_question` (
  ...
  `fldiSubject` int(11) NOT NULL,
  `fldiChapter` int(11) NOT NULL,
  `fldiTopics` int(11) NOT NULL,
  `fldvQuestion` text NOT NULL,
  `fldvDetails` text NOT NULL,
  `fldvHint` text NOT NULL,
...
INSERT INTO `tbl_question` (`fldiQtnId`, `fldiSubject`, `fldiChapter`, `fldiTopics`, `fldvQuestion`, `fldvDetails`, `fldvHint`, `fldvOptionA`, `fldvOptionB`, `fldvOptionC`, `fldvOptionD`, `fldvAns`, `fldcStatus`, `fldvPostion`, `flddDate`) VALUES
(1, 1, 3, 8, 'Which of the following respective Phase-1 and Phase-II reactions are the most common drug biotransformation reactions?', 'Description for answer which makes ans right', 'Description for answer which makes ans right', 'Oxidation and Glucuronidation', 'Reduction and Acetylation', 'Hydrolysis and Glucuronidation', 'Oxidat ion and Glutat hion conjugat ion', 'fldvOptionA', 'Y', 0, '2015-11-05 19:47:05');
...
(2, 'World Best Motivational Videos for Students', 'Tjnq5StX68g', 0, 'Y'),
(3, 'WORST PLANE CRASHES CAUGHT ON CAMERA!!', 'tqDK1MvWz-8', 0, 'Y'),
(4, 'WORST PLANE CRASHES CAUGHT ON CAMERA!!', 'tqDK1MvWz-8', 0, 'Y');
...
--
ALTER TABLE `tbl_banner`
  MODIFY `fldiBnrId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_client`
  MODIFY `fldiClntId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_contacts`
--
ALTER TABLE `tbl_contacts`
  MODIFY `fldiCtntId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_faq`
  MODIFY `fldiFaqId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_job`
  MODIFY `fldiJobId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tbl_news`
  MODIFY `fldiNewsId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_pages`
  MODIFY `fldiPageId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=353;
...
--
ALTER TABLE `tbl_post`
  MODIFY `fldiPostId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_product_cat`
--
ALTER TABLE `tbl_product_cat`
  MODIFY `fldiCatId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tbl_question`
--
ALTER TABLE `tbl_question`
  MODIFY `fldiQtnId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_videos`
  MODIFY `fldiVideoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_webcms`
--
ALTER TABLE `tbl_webcms`
  MODIFY `fldiCmsId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
